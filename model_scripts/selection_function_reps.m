function [n_m_mat_reps, div_per_gen_reps, n_pops_reps, aa_pops_reps, s_pops_reps, k_avg_vec, avg_length_long_vec, N_m_vec_vec, p_c_vec_vec, meta_data] = selection_function_reps(n, n_gen, AA_min, N_min, S_min, p_p_min, p_c_min, p_t_min,p_d,cat_c, cat_p, w,gamma, gamma2, epsilon, alpha,beta,er, min_length_for_avg, reps)

n_m_mat_reps = cell(1,reps);
div_per_gen_reps = cell(1,reps);
n_pops_reps = cell(1,reps);
aa_pops_reps = cell(1,reps);
s_pops_reps = cell(1,reps);
...
Parameter = ["n"; "n_gen"; "AA_min"; "N_min";"S_min"; "p_p_min"; "p_c_min"; "p_t_min";"p_d";"cat_c"; "cat_p"; "w";"gamma";"gamma2"; "epsilon"; "alpha";"beta";"er"; "min_length_for_avg"; "reps"];
Value = [n, n_gen, AA_min, N_min,S_min, p_p_min, p_c_min, p_t_min,p_d,cat_c, cat_p, w,gamma,gamma2, epsilon, alpha,beta,er, min_length_for_avg, reps]';
